...
#      pressure=plevelTCC
      ...
      Cn2_data_nc.createDimension('nlev',nlev_all)
      ...
      Cn2_data.variables['lats']=lats[:]
      Cn2_data.variables['lons']=lons[:]
      Cn2_data.variables['levs']=pressure[:]
      Cn2_data.variables['Cn2']=Cn2[:] 
      Cn2_data.close()
