...
FCST_IH=12 ## IH=Interval Hour
last_IH= int(np.floor(int(currhr)/FCST_IH) * FCST_IH)
if last_IH<10:
...
## Experiment
yrmoda_str = '20200106'
yrmodahr_str = '2020010600'
hr_str = '00'
#####################
WXpath='https://nomads.ncep.noaa.gov/pub/data/nccf/com/fnmoc/prod/fens_wave.'+yrmoda_str+'/'+hr_str+'/'
file='ENSEMBLE.halfDegree.OCN.fcst_et010.000.'+yrmodahr_str
##file='ENSEMBLE.halfDegree.OCN.fcst_et' ENSEMBLE #000-020
